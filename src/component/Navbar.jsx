  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-light mb-4 d-flex justify-content-between">
      ...
      {user?<div>
        ...
        <img onClick={()=>handleLogout()} className="mx-5" src={logoutImg} width='24' height='24' alt="" srcSet="" />
