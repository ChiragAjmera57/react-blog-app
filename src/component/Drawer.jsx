...
export default function SwipeableTemporaryDrawer() {
  ...
  return (
    <div>
         <svg onClick={()=>setdrawer(true)} width="24" height="24" viewBox="0 0 24 24" className="wz">
    ...
    <SwipeableDrawer
          ...
          >
            <div className='' style={{width:'450px'}}>
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="bz ic"><path d="M5 5l7 7m7 7l-7-7m0 0l7-7m-7 7l-7 7" stroke="currentColor" strokeLinecap="round"></path></svg>
                </div>
                </div>
                <div className='card p-3 m-auto shadow' style={{width:'90%'}}>
                    <div className='d-flex align-items-center'>
                        <img className='rounded-5' src="https://miro.medium.com/v2/resize:fill:40:40/0*eizS15M9MOWoKwUN" alt="" />
                        <p className='mx-3 mt-2'>Chirag Ajmera</p>
                    </div>
                        <textarea className='border-0 input-group p-3' style={{resize:'none',outline:'none'}} placeholder='What are your throughts?' name="" id="" cols="5" rows="5">
                        </textarea>
                        <div className='d-flex align-items-center justify-content-end'>
                        <p className='m-3'>Cancel</p>
                        <button className='btn bg-success border-0 btn-ouline-none text-white'>Respond</button>
                        </div>
